    ...
    router.get(
        ...
        a(
            async (req: express.Request, res: express.Response): Promise<void> => {
                const parsed: sequelize.FindOptions<VariableInstance> = Parser.parseQuery<VariableInstance>(
                    req.query.q,
                    models,
                );
                const data: PaginatedResult<VariableInstance> = await models.Variable.findAndCountAll(parsed);
